...
function loadResponsiveNavbar() {
	if(document.getElementById('responsive_navbar1').style.display == "block") {
		// document.getElementById('logo_hide').style.display = "block"
		document.getElementById('responsive_navbar1').style.display = "none";
		document.getElementById('header_responsive_bar2').style.display = "none";
		document.getElementById('header_responsive_bar1').style.display = "block";
	}
	else {
		// document.getElementById('logo_hide').style.display = "none"
		document.getElementById('responsive_navbar1').style.display = "block";
		document.getElementById('header_responsive_bar1').style.display = "none";
		document.getElementById('header_responsive_bar2').style.display = "block";
	}
	// console.log("test console",document.getElementById('responsive_navbar').style.display);

	// document.getElementById('header_responsive_bar1').style.display = "none"
}

function aggr1over() {
	document.getElementById('aggr1call').style.display = "block"
}

function aggr1out() {
	document.getElementById('aggr1call').style.display = "none"
}

function aggr2over() {
	document.getElementById('aggr2call').style.display = "block"
}

function aggr2out() {
	document.getElementById('aggr2call').style.display = "none"
}

function aggr3over() {
	document.getElementById('aggr3call').style.display = "block"
}

function aggr3out() {
	document.getElementById('aggr3call').style.display = "none"
}

function edu1over() {
	document.getElementById('edu1call').style.display = "block"
}

function edu1out() {
	document.getElementById('edu1call').style.display = "none"
}

function edu2over() {
	document.getElementById('edu2call').style.display = "block"
}

function edu2out() {
	document.getElementById('edu2call').style.display = "none"
}

function custom1over() {
	document.getElementById('custom1call').style.display = "block"
}

function custom1out() {
	document.getElementById('custom1call').style.display = "none"
}

function custom2over() {
	document.getElementById('custom2call').style.display = "block"
}

function custom2out() {
	document.getElementById('custom2call').style.display = "none"
}

function org1over() {
	document.getElementById('org1call').style.display = "block"
}

function org1out() {
	document.getElementById('org1call').style.display = "none"
}

function org2over() {
	document.getElementById('org2call').style.display = "block"
}

function org2out() {
	document.getElementById('org2call').style.display = "none"
}
